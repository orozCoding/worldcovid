  ...
  return (
    <div className="selfCountries d-flex col">
      <div className="countryContainer d-flex col">
        ...
        <div className="selfDate d-flex"><p className="bold">Date:</p><p>{country.date}</p> </div>
        <div className="selfStats">
          <div className="d-flex"><p className="bold">Total Cases:</p><p>{country.today_confirmed}</p> </div>
          <div className="d-flex"><p className="bold">Total Deaths:</p><p>{country.today_deaths}</p> </div>
